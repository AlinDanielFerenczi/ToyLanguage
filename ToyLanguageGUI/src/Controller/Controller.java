...
public class Controller {
    ...
    Controller(IRepository repository, boolean displayFlag) {
...
/*    private PrgState oneStep(PrgState state) throws ProgramException {
    ...
    public Map<Integer,IValue> getHeapRepresentation() {
        IList<PrgState> prgList = repository.getPrgList();
        return prgList.size()>0
                ? prgList.current(0).getHeap().getContent()
                : new HashMap<Integer, IValue>();
    }
