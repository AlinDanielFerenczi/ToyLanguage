...
public class SelectionViewController implements Initializable {
    private ProgramRepository createPrograms() {
        ...
        if(new File("log12.txt").delete())
            System.out.println("Log 12 deleted!");
        ...
        try {
            PrgState prg1 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex1, new ProgramBarrier());
        ...
        try {
            PrgState prg2 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex2, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg3 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex3, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg4 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex4, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg5 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex5, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg6 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex6, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg7 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex7, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg8 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex8, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg9 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex9, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg10 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex10, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
        ...
        try {
            PrgState prg11 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex11, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
                                                        ...
                                                        new CompStmt(new NewStmt("v3", new ValueExp(new IntValue(4))),
                                                                new CompStmt(new NewBarrier("cnt", new ReadHeapExp(new VarExp("v2"))),
                                                                        new CompStmt(new ForkStmt(new CompStmt(new AwaitStmt("cnt"),
                                                                                    new CompStmt(new AssignStmt("v1", new WriteHeapExp("v1",new ArithExp('*',new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(10))))),
                                                                                            new PrintStmt(new ReadHeapExp(new VarExp("v1")))))),
                                                                                new CompStmt(new ForkStmt(new CompStmt(new AwaitStmt("cnt"),
                                                                                        new CompStmt(new AssignStmt("v2", new WriteHeapExp("v2", new ArithExp('*',new ReadHeapExp(new VarExp("v2")), new ValueExp(new IntValue(10))))),
                                                                                                new CompStmt(new AssignStmt("v2", new WriteHeapExp("v2",new ArithExp('*',new ReadHeapExp(new VarExp("v2")), new ValueExp(new IntValue(10))))),
        ...
        try {
            PrgState prg12 = new PrgState(new ProgramStack<IStmt>(), new ProgramDictionary<String, IValue>(),
                    new ProgramList<IValue>(), new ProgramDictionary<String, BufferedReader>(), new ProgramHeap<IValue>(), ex12, new ProgramBarrier());
            listOfThreads = new ProgramList<PrgState>();
            listOfThreads.add(prg12);
            Repository repository12 = new Repository(listOfThreads, "log12.txt");
            Controller controller12 = new Controller(repository12, true);
