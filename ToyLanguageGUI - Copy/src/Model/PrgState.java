...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> stk, IDictionary<String,IValue> symTbl,
             IList<IValue> ot, IDictionary<String, BufferedReader> fileTbl, IHeap<IValue> heapDict, IStmt prg, IBarrier barrierTbl) throws ProgramException {
    ...
    public IBarrier getBarrier() { return barrierTable;}
